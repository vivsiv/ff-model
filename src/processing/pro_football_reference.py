...
class ProFootballReferenceProcessor:
    ...
    def __init__(self, data_dir: str):
        ...
        self.silver_dir = os.path.join(data_dir, "silver", "pfr")
    ...
    def combine_year_data(self,
        ...
        """
        file_pattern = os.path.join(self.bronze_dir, file_pattern)
    ...
    def write_to_silver(self, df: pd.DataFrame, file_name: str) -> None:
        ...
        """
        table_path = os.path.join(self.silver_dir, file_name)
...
def main():
    parser = argparse.ArgumentParser(
        description="Processes pro football reference bronze data into silver layer tables"
    )
    parser.add_argument(
        "--data-dir",
        type=str,
